...
const STYLES = `
${NAV_STYLES}
.pI_x6G_overlayLayer:has(.dsh-taskboard-page){z-index:30}.dsh-taskboard-page{position:absolute;top:0;bottom:0;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:#fff;color:var(--dsw-alias-label-primary,#0f1115);font:14px/22px system-ui,sans-serif;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2,#d4d4d4);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2,#c4c4c4)}
