...
const zh = {
  ...
  due: '截止', recentTasks: '最近任务', priority: '优先级', loading: '正在读取本地任务数据…', workflowNote: '保存的可视化工作流与能力目录将在这里显示。', search: '搜索任务', allStatuses: '全部状态', deleteProject: '删除项目', editProject: '编辑项目', newSession: '在新会话中打开', workspaceRequired: '请先为项目映射 Workspace',
...
const en = {
  ...
  due: 'Due', recentTasks: 'Recent tasks', priority: 'Priority', loading: 'Reading local task data…', workflowNote: 'Saved visual workflows and the capability catalog appear here.', search: 'Search tasks', allStatuses: 'All statuses', deleteProject: 'Delete project', editProject: 'Edit project', newSession: 'Open in new session', workspaceRequired: 'Map a Workspace to this project first',
  ...
  more: 'More', modify: 'Modify', runNow: 'Run now',
