...
const zh = {
  ...
  due: '截止', recentTasks: '最近任务', priority: '优先级', loading: '正在读取本地任务数据…', workflowNote: '保存的工作流会作为 Agent 执行指引加入任务上下文；节点不会由调度器自动运行。', search: '搜索任务', allStatuses: '全部状态', deleteProject: '删除项目', editProject: '编辑项目', newSession: '在新会话中打开', workspaceRequired: '请先为项目映射 Workspace',
